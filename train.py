...
from models.matching import MatchingForTraining
...
parser.add_argument(
    ...
    help='batch_size')
parser.add_argument(
    '--train_path', type=str, default='D:/resource/SuperGlue_SuperPoint_MegaDepth/Frame', 
    help='Path to the directory of training imgs.')
parser.add_argument(
    '--eval_path', type=str, default='D:/resource/SuperGlue_SuperPoint_MegaDepth/Frame2', 
    help='Path to the directory of training imgs.')
parser.add_argument(
...
if __name__ == '__main__':
    ...
    config = {
        ...
        'supgerglue': {
            ...
            'descriptor_dim': detector_dims['superpoint'],
    ...
    #     preprocessing=opt.preprocessing
    # )
    valid_set = SparseDataset(opt.eval_path, opt.max_keypoints)
    validation_loader = torch.utils.data.DataLoader(dataset=valid_set, shuffle=False, batch_size=opt.batch_size, drop_last=True, num_workers=0)
